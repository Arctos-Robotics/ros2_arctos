...
void UartProtocol::readEncoderValues(int &val_1, int &val_2)
{
...
void UartProtocol::setMotorValues(int val_1, int val_2)
{
    std::stringstream ss;
    ss << "m " << val_1 << " " << val_2 << "\r";
...
void UartProtocol::setPidValues(float k_p, float k_d, float k_i, float k_o)
{
    std::stringstream ss;
...
std::string UartProtocol::sendMsg(const std::string &msg_to_send, bool print_output)
{
